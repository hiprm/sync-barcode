...
const csvFilePath1 = 'D:/training/PROLOGICS/'+dateFormatted+'.csv'; // Replace with the path to your second CSV file
const apiUrl1 = 'http://localhost:3000/api/barcode-registry/in-balancing-file'; // Replace with your second API endpoint
...
async function uploadFile() {
  try {
    ...
    const apiUrl = 'http://localhost:3000/api/file-upload/upload-inbalance';
